...
namespace anagrama
{
    ...
    public partial class frm_fasedificil : Form
    {
        ...
        private void TxtAnagrama_TextChanged_1(object sender, EventArgs e)
        {
            ...
            if (lblZoo.Text == "ZOO" && lblOdio.Text == "ÓDIO" && lblCozinha.Text == "COZINHA" && lblCanho.Text == "CANHO" && lblDona.Text == "DONA"
                   && lblCha.Text == "CHÁ" && lblOca.Text == "OCA" && lblOco.Text == "OCO" && lblDono.Text == "DONO" && lblZinco.Text == "ZINCO")
            {
